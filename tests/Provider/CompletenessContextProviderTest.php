...
final class CompletenessContextProviderTest extends TestCase
{
    use ProphecyTrait;
    ...
    {
        $repository = $this->prophesize(CompletenessContextRepositoryInterface::class);
        $repository->findAll()->willReturn([]);

        $provider = new CompletenessContextProvider($repository->reveal());
    ...
    {
        $setting = new CompletenessContext();
